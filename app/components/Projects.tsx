  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-wrap gap-4 px-4">
        <div className="hover:bg-secondary hover:text-primary transition-all duration-300 w-[400px]" >
        ...
        </div> <div className="hover:bg-secondary hover:text-primary transition-all duration-300 w-[400px]" >
          <p>blog backend</p>
